...
namespace Nuxleus.Performance {
    ...
    public struct PerformanceTimer : IDisposable {
        ...
        void SetMarker() {
            ...
            m_setMarkerStack.Push(m_stopwatch.ElapsedTicks);
        }
        ...
        /// </summary>
        void ReleaseMarker() {
            m_releaseMarkerStack.Push(m_stopwatch.ElapsedTicks);
        }
        ...
        public double Elapsed {
            get {
                return (m_stopwatch.ElapsedTicks / (double)m_freq) * (Double)UnitPrecision;
            }
        }

        double GetDuration(long startTime, long stopTime) {
            return ((double)(stopTime - startTime) / (double)m_freq) * (Double)UnitPrecision;
        }
