...
public static class DynamicWebServiceHelpers {
    ...
    public static void Register(CodeContext/*!*/ context) {
        // register member injectors
        context.LanguageContext.DomainManager.LoadAssembly(typeof(DynamicWebServiceHelpers).Assembly);
    }
