...
namespace Thought.Net.vCards
{
    ...
    public class vCardStandardReader : vCardReader 
    {
        ...
        ///     corresponding <see cref="vCardPhoneType"/> value.
        /// </summary>
        /// <param name="name">
        ...
        /// </returns>
        public static vCardPhoneType ParsePhoneType(string name)
        {

            if (string.IsNullOrEmpty(name))
                return vCardPhoneType.Default;
            ...
            switch (name.Trim().ToUpperInvariant())
            {
                ...
                case "BBS":
                    return vCardPhoneType.BBS;

                case "CAR":
                    return vCardPhoneType.Car;

                case "CELL":
                    return vCardPhoneType.Cellular;

                case "FAX":
                    return vCardPhoneType.Fax;

                case "HOME":
                    return vCardPhoneType.Home;

                case "ISDN":
                    return vCardPhoneType.ISDN;

                case "MODEM":
                    return vCardPhoneType.Modem;

                case "MSG":
                    return vCardPhoneType.MessagingService;

                case "PAGER":
                    return vCardPhoneType.Pager;

                case "PREF":
                    return vCardPhoneType.Preferred;

                case "VIDEO":
                    return vCardPhoneType.Video;

                case "VOICE":
                    return vCardPhoneType.Voice;

                case "WORK":
                    return vCardPhoneType.Work;
        ...
        ///     ignored.
        /// </returns>
        public static vCardPhoneType ParsePhoneType(string[] names)
        {

            vCardPhoneType sum = vCardPhoneType.Default;
        ...
        /// </param>
        /// <returns>
        ///     The <see cref="vCardPostalAddressType"/> that corresponds
        ///     with the TYPE keyword, or vCardPostalAddressType.Default if
        ///     the type could not be identified.
        /// </returns>
        public static vCardDeliveryAddressType ParseDeliveryAddressType(string value)
        {

            if (string.IsNullOrEmpty(value))
                return vCardDeliveryAddressType.Default;

            switch (value.ToUpperInvariant())
            {
                case "DOM":
                    return vCardDeliveryAddressType.Domestic;

                case "HOME":
                    return vCardDeliveryAddressType.Home;

                case "INTL":
                    return vCardDeliveryAddressType.International;

                case "PARCEL":
                    return vCardDeliveryAddressType.Parcel;

                case "POSTAL":
                    return vCardDeliveryAddressType.Postal;

                case "WORK":
                    return vCardDeliveryAddressType.Work;
        ...
        /// </param>
        /// <returns>
        ///     A <see cref="vCardPostalAddressType"/> flags enumeration
        ///     that corresponds with all known type names from the array.
        /// </returns>
        public static vCardDeliveryAddressType ParseDeliveryAddressType(string[] typeNames)
        {

            vCardDeliveryAddressType allTypes = vCardDeliveryAddressType.Default;
        ...
        /// </summary>
        /// <param name="stream">
        ///     A readable stream containing the contents of
        ///     a standard vCard file.
        /// </param>
        /// <returns>
        ///     An initialized <see cref="vCard"/> object representing
        ///     the vCard contents loaded from the stream.
        /// </returns>
        public override void ReadInto(vCard card, TextReader reader)
        {
            ...
            do
            {
                ...
                if (property != null)
                {
                    ...
                    if (
                        (string.Compare("END", property.Name, true) == 0) &&
                        (string.Compare("VCARD", property.ToString(), true) == 0))
                    {
        ...
        private void ReadInto_ADR(vCard card, vCardProperty property)
        {
            ...
            foreach (vCardSubproperty sub in property.Subproperties)
            {
                ...
                if (
                    ...
                    (string.Compare("TYPE", sub.Name, true) == 0))
                {
        ...
        private void ReadInto_PHOTO(vCard card, vCardProperty property)
        {
            ...
            if (string.Compare(valueType, "URI", true) == 0)
            {
        ...
        private void ReadInto_TEL(vCard card, vCardProperty property)
        {
            ...
            foreach (vCardSubproperty sub in property.Subproperties)
            {
                ...
                if (
                    (string.Compare(sub.Name, "TYPE", true) == 0) &&
                    (!string.IsNullOrEmpty(sub.Value)))
                {
