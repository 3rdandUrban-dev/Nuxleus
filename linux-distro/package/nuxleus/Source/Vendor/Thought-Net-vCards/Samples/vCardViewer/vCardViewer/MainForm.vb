    ...
    Public Sub Populate(ByVal card As vCard)
        ...
        With card
            ...
            SetSummaryValue( _
                ...
                .Phones.GetFirstChoice(vCardPhoneType.Cellular))
            ...
            SetSummaryValue( _
                HomePhoneValue, _
                .Phones.GetFirstChoice(vCardPhoneType.HomeVoice))
            ...
            SetSummaryValue( _
                PagerValue, _
                .Phones.GetFirstChoice(vCardPhoneType.Pager))

            ' Personal Home Page

            SetSummaryValue( _
                PersonalWebSiteValue, _
                .WebSites.GetFirstChoice(vCardWebSiteType.Personal))
            ...
            SetSummaryValue( _
                WorkFaxValue, _
                .Phones.GetFirstChoice(vCardPhoneType.Fax))

            ' Work Phone

            SetSummaryValue( _
                WorkPhoneValue, _
                .Phones.GetFirstChoice(vCardPhoneType.WorkVoice))

            ' Work Web Site

            SetSummaryValue( _
                WorkWebSiteValue, _
                .WebSites.GetFirstChoice(vCardWebSiteType.Work))
