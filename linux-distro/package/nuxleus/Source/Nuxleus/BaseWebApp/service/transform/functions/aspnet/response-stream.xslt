<?xml version="1.0"?>
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:func="http://atomictalk.org/function" xmlns:response="http://atomictalk.org/function/aspnet/response" xmlns:saxon="http://saxon.sf.net/" xmlns:response-stream="clitype:System.Web.HttpResponse?partialname=System.Web" xmlns:clitype="http://saxon.sf.net/clitype" version="2.0" exclude-result-prefixes="xs func clitype saxon response-stream">
