//
// createqueue.cs: Client API for the bucker queue system
//
// Author:
...
{
  public class QueueCreation : Message {
    public QueueCreation() : base() {
      this.Op = Operation.NewQueue;
    }

    public QueueCreation(IMessage m) : base(m) {
    }
	...
	xw.WriteStartElement("new-queue", QS_NS);
	xw.WriteEndElement(); // </new-queue>
