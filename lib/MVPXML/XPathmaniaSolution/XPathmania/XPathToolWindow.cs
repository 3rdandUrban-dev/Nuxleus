...
namespace XmlMvp.XPathmania
{
    ...
    /// </summary>
    [Guid("7190d388-efff-4101-bb33-9d83861d7d0b")]
    public class XPathToolWindow : ToolWindowPane
    {
        ...
        private XPathToolControl control;

        /// <summary>
        /// Standard constructor for the tool window.
        /// </summary>
        public XPathToolWindow() :
            base(null)
        {
