...
using Nuxleus.Mvc.WebApp.Controllers;
using Nuxleus.Mvc.WebApp.Logic;
using Nuxleus.Mvc.WebApp.Models;
using Nuxleus.Mvc.WebApp.ServiceInterface;

[assembly: WebActivator.PreApplicationStartMethod(typeof(Nuxleus.Mvc.WebApp.AppHost), "Start")]
  ...
  public class AppHost : AppHostBase
  {
    ...
    private void ConfigureAuth(Funq.Container container)
    {
      ...
      container.Register<IDbConnectionFactory>(
        new OrmLiteConnectionFactory(connStr, true, //ConnectionString in Web.Config
