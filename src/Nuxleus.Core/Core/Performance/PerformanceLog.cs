...
namespace Nuxleus.Core.Performance
{
    ...
    [XmlType(Namespace = "http://nuxleus.com/Nuxleus/Core/Performance")]
    [XmlRootAttribute(Namespace = "http://nuxleus.com/Nuxleus/Core/Performance", IsNullable = false)]
    ...
    [XmlTypeAttribute(Namespace = "http://nuxleus.com/Nuxleus/Core/Performance")]
