...
<xsl:stylesheet version="1.0" xmlns:html="http://www.w3.org/1999/xhtml"
  xmlns:my="http://xameleon.org/my" xmlns:page="http://atomictalk.org/page"
  xmlns:doc="http://atomictalk.org/feed/doc" xmlns:service="http://atomictalk.org/page/service"
  ...
  xmlns:app="http://purl.org/atom/app#" xmlns:atompub="http://www.w3.org/2007/app"
  ...
  <xsl:template match="model:collection[@src]">
    <ul class="list {@style}" id="{@id}">
  ...
  <xsl:template match="view:item[@src]|collection:item[@src]">
    <li class="list {@style}" id="{@id}">
      <xsl:apply-templates select="document(@src)/*"/>
    </li>
  </xsl:template>

  <xsl:template match="view:item[not(@src)]|collection:item[not(@src)]">
    <li class="list menu {@style}" id="{@id}">
      <xsl:apply-templates/>
    </li>
  </xsl:template>
