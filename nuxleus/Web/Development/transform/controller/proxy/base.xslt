...
<xsl:transform version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:func="http://atomictalk.org/function" xmlns:http-sgml-to-xml="clitype:Xameleon.Function.HttpSgmlToXml?partialname=Xameleon"
    xmlns:aspnet-context="clitype:System.Web.HttpContext?partialname=System.Web" xmlns:proxy="http://xameleon.org/service/proxy"
    ...
    <xsl:template match="proxy:return-xml-from-html">
        ...
        <xsl:variable name="uri" select="concat($protocol, '://', substring-before(substring-after($uri-xpath, '://'), '//'))" />
