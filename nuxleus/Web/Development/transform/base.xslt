...
<xsl:transform version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    xmlns:saxon="http://saxon.sf.net/" xmlns:clitype="http://saxon.sf.net/clitype"
    ...
    xmlns:browser-capabilities="clitype:System.Web.HttpBrowserCapabilities?partialname=System.Web" xmlns:timestamp="clitype:System.DateTime"
    xmlns:uri="clitype:System.Uri?partialname=System" xmlns:func="http://atomictalk.org/function" xmlns:exsl="http://exslt.org/common"
    xmlns:aws="http://xameleon.org/function/aws" xmlns:sdb="http://xameleon.org/function/aws/sdb"
    xmlns:service="http://xameleon.org/service" xmlns:profile="http://xameleon.org/service/profile"
    xmlns:operation="http://xameleon.org/service/operation" xmlns:param="http://xameleon.org/service/session/param"
    ...
    <xsl:template match="profile:create-new">
        ...
        <xsl:variable name="file"
            select="resolve-uri(concat('file:///nuxleus/Web/Development/userprofile/', $username, '/', 'profile.xml'))" />
        <file>
