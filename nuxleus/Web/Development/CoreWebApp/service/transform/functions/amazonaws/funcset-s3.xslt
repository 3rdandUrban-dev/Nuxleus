...
<xsl:transform version="2.0"
    ...
    xmlns:s3="clitype:Nuxleus.Utility.S3.AWSAuthConnection?partialname=Nuxleus.Utility"
    xmlns:s3response="clitype:Nuxleus.Utility.S3.Response?partialname=Nuxleus.Utility"
    xmlns:awsAuth="clitype:Nuxleus.Utility.S3.AWSAuthConnection?partialname=Nuxleus.Utility"
    xmlns:auth="clitype:Nuxleus.Utility.S3.QueryStringAuthGenerator?partialname=Nuxleus.Utility"
