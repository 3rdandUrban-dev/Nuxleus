//
// MessageQueueServer.cs: Base server 
//
// Author:
...
namespace Nuxleus.Messaging {
  public class MessageQueueServer {
    ...
    public MessageQueueServer(int port, string delimiter) {
    ...
    /// <summary>
    /// Gets the actual server object handling the connections and dispatching on socket events.
    /// </summary>
