...
namespace Nuxleus.Extension.Aws.Sdb
{
    public struct Item
    {
        ...
        public GetAttributesResponse GetAttributes ()
        {
            ...
            string response = m_connection.MakeRequest(uri, "GetAttributes", parameters);
        ...
        public Response PutAttributes (IList attributes, bool replace)
        {
            ...
            string response = m_connection.MakeRequest(uri, "PutAttributes",
                                 parameters);
        ...
        public Response DeleteAttributes (IList attributes)
        {
            ...
            string response = m_connection.MakeRequest(uri, "DeleteAttributes", parameters);
