...
function DisplayUsage(i_Text)
	{
	var Text = "Usage:\r\nfsRSSMerge.js [LocalPath] [IncomingPath]\r\n\r\nParameters:\r\n  LocalPath=fully qualified filename of local RSS document (required)\r\n  IncomingPath=fully qualified filename for incoming RSS document (required)\r\n";
