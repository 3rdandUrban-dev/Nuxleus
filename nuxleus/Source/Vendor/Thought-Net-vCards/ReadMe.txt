...
vCard Class Library for .NET (Version 0.3; LGPL license)
Copyright (c) 2007 David Pinch * http://www.thoughtproject.com/Libraries/vCard/
...
Folders (directories):
    ...
    .\Solution\
        ...
        The Solution folder contains a Visual Studio 2005 solution for building the
        vCard class library.
    ...
    .\Unit Tests\
        ...
        Unit tests written for the NUnit framework.  Refer to the ReadMe.txt file
        in the project for information on downloading and installing Nunit.


Current Status

    This is version 0.3 of the library.  It implements a substantial portion of the
    ...
    Known issues to be fixed in a future release (before version 1.0):
        ...
        - Only Outlook-style birthdates are supported.
        - Preferred addresses and labels not marked as preferred

    The next release should be mid to late September, 2007.  You will be
    able to download it from http://www.thoughtproject.com/Libraries/vCard/.
...
Credits
    ...
    to Robbie Paplin for helping with image (photo) support.
...
License and Copyrights
  ...
  vCard Class Library for .NET (version 0.3 -- alpha)
