...
{
	/// <summary>	
	/// Allows to navigate a subtree of an IXPathNavigable source, 
	...
	/// </remarks>
	public class SubtreeeXPathNavigator : XPathNavigator
	{
		#region Fields & Ctors
		...
		/// <summary>
		/// Creates SubtreeeXPathNavigator over specified XPathNavigator.
		/// </summary>
		...
		/// <see cref="SubtreeeXPathNavigator"/>.</remarks>
		public SubtreeeXPathNavigator(XPathNavigator navigator) : this(navigator, false)
		{
		} 
		...
		/// which isolates the calling code from movements to the 
		/// <see cref="SubtreeeXPathNavigator"/>.</remarks>
		public SubtreeeXPathNavigator(XPathNavigator navigator, bool enableFragment)
		{
		...
		{
			return new SubtreeeXPathNavigator(_root, _navigator, _atroot, _fragment);
		}
		...
		public override bool MoveTo(XPathNavigator other) 
		{
			...
			return _navigator.MoveTo(((SubtreeeXPathNavigator)other)._navigator);
		}
