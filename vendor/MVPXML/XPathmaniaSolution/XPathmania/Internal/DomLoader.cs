...
{
    /// <summary>
    /// This class keeps track of DOM node line locations so you can do highlighting.
    /// </summary>
    internal class DomLoader
    {
        ...
        internal XmlDocument Load(XmlReader r)
        {
    ...
    #region Internal LineInfo class
