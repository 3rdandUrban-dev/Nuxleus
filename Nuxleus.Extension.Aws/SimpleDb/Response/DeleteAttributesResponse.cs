...
namespace Nuxleus.Extension.Aws.SimpleDb
{
    ...
    public class DeleteAttributesResponse : IResponse, IXmlSerializable
    {
        ...
        [XmlElementAttribute(ElementName = "DeleteAttributesResult")]
        ...
        public void ReadXml(XmlReader reader) {
            DeleteAttributesResult result = new DeleteAttributesResult();
